...
public abstract class FabriclikeInstallFragment extends Fragment implements ModloaderDownloadListener, CompoundButton.OnCheckedChangeListener {
    ...
    public void onDataNotAvailable() {
        Tools.runOnUiThread(()->{
            ...
            Tools.dialog(context,
                    ...
                    context.getString(com.choice.launcher.R.string.fabric_dl_cant_read_meta, mFabriclikeUtils.getName()));
        });
    }
    ...
    private void updateLoaderVersions() {
        startLoading();
        mLoaderVersionFuture = new SelfReferencingFuture(new LoadLoaderVersionsTask()).startOnExecutor(BitLauncherApplication.Companion.getSExecutorService());
    }
    ...
    private void updateGameVersions() {
        startLoading();
        mGameVersionFuture = new SelfReferencingFuture(new LoadGameVersionsTask()).startOnExecutor(BitLauncherApplication.Companion.getSExecutorService());
    }

...
JNIEXPORT void JNICALL Java_com_redemastery_oldapi_pojav_utils_JREUtils_setupBridgeWindow(JNIEnv* env, ABI_COMPAT jclass clazz, jobject surface) {
...
Java_com_redemastery_oldapi_pojav_utils_JREUtils_releaseBridgeWindow(ABI_COMPAT JNIEnv *env, ABI_COMPAT jclass clazz) {

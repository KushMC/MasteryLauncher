package com.redemastery.oldapi.pojav.modloaders.modpacks.imagecache;
...
public class IconCacheJanitor implements Runnable{
    ...
    public static void runJanitor() {
        synchronized (IconCacheJanitor.class) {
            ...
            sJanitorFuture = MasteryLauncherApplication.Companion.getSExecutorService().submit(new IconCacheJanitor());
        }
    }

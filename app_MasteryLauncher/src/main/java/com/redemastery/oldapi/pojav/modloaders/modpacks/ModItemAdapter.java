package com.redemastery.oldapi.pojav.modloaders.modpacks;
...
import com.redemastery.oldapi.pojav.modloaders.modpacks.api.ModpackApi;
import com.redemastery.oldapi.pojav.modloaders.modpacks.imagecache.ImageReceiver;
import com.redemastery.oldapi.pojav.modloaders.modpacks.imagecache.ModIconCache;
import com.redemastery.oldapi.pojav.modloaders.modpacks.models.Constants;
...
public class ModItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements TaskCountListener {
    ...
    public void performSearchQuery(SearchFilters searchFilters) {
        ...
        mTaskInProgress = new SelfReferencingFuture(new SearchApiTask(mSearchFilters, null))
                .startOnExecutor(MasteryLauncherApplication.Companion.getSExecutorService());
    }

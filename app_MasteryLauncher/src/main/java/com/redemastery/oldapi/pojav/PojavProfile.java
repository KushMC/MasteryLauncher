...
public class PojavProfile {
	...
	public static UserAccount getCurrentProfileContents(@NonNull Context ctx, @Nullable String profileName) {
		return UserAccount.Companion.load(profileName == null ? getCurrentProfileName(ctx) : profileName);
	}

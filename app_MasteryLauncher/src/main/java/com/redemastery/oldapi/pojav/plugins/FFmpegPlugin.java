package com.redemastery.oldapi.pojav.plugins;
...
public class FFmpegPlugin {
    ...
    public static void discover(Context context) {
        ...
        try {
            PackageInfo ffmpegPluginInfo = manager.getPackageInfo("com.redemastery.oldapi.pojav.ffmpeg", PackageManager.GET_SHARED_LIBRARY_FILES);
